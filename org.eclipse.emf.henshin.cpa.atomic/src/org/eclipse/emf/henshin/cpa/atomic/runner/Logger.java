...
public class Logger {
	...
	public void init(int numberOfRules){
		...
		runtimeResults = new String[numberOfRules+1][numberOfRules+1]; // + ruleName
		numberOfDeleteUseConflicts = new String[numberOfRules+1][numberOfRules+1]; // + ruleName
...
//			String ruleDetails = analyseDetailsOfRule(rule1);
		...
		if(columnPosition == null){
			...
			numberOfDeleteUseConflicts[0][columnPosition] = ruleDetails + rule2.getName();
		}
