...
//		assertThat(resultGraph.getNodes().size(), is(equalTo(13)));

		assertEquals(16, resultGraph.getEdges().size());
//		assertThat(resultGraph.getEdges().size(), is(equalTo(16)));
	}
...
//		assertThat(resultGraph.getEdges().size(), is(equalTo(16)));
	...
	//TODO: was passiert wenn zwei Knoten unterschiedlichen types durch den Span einaner zugeordnet werden?
